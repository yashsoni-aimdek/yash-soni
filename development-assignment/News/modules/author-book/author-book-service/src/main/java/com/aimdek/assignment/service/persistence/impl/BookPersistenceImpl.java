...
package com.aimdek.assignment.service.persistence.impl;
...
import com.aimdek.assignment.model.BookTable;
import com.aimdek.assignment.model.impl.BookImpl;
import com.aimdek.assignment.model.impl.BookModelImpl;
...
import com.aimdek.assignment.service.persistence.impl.constants.NewsPersistenceConstants;
...
public class BookPersistenceImpl
	...
	public Book[] findByAuthorId_PrevAndNext(
		...
		try {
			...
			array[0] = getByAuthorId_PrevAndNext(
				session, book, authorId, orderByComparator, true);

			array[1] = book;

			array[2] = getByAuthorId_PrevAndNext(
				session, book, authorId, orderByComparator, false);
	...
	public void activate() {
		...
		bookToAuthorTableMapper = TableMapperFactory.getTableMapper(
			"News_Author_Book#bookId", "News_Author_Book", "companyId",
			"bookId", "authorId", this, Author.class);
	...
	public void deactivate() {
		...
		TableMapperFactory.removeTableMapper("News_Author_Book#bookId");
	}
