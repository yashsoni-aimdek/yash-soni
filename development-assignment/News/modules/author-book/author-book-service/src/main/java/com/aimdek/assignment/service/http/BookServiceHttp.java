...
import com.aimdek.assignment.service.BookServiceUtil;
...
public class BookServiceHttp {
	...
	public static com.aimdek.assignment.model.Book getBook(
			HttpPrincipal httpPrincipal, long bookId)
		throws com.liferay.portal.kernel.exception.PortalException {

		try {
			MethodKey methodKey = new MethodKey(
				BookServiceUtil.class, "getBook", _getBookParameterTypes0);
			...
			return (com.aimdek.assignment.model.Book)returnObj;
		}
