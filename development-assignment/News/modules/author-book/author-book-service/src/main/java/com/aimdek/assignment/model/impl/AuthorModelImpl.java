...
import com.aimdek.assignment.model.AuthorModel;
...
/**
 * The base model implementation for the Author service. Represents a row in the &quot;News_Author&quot; database table, with each column mapped to a property of this class.
 *
 * <p>
...
public class AuthorModelImpl
	 ...
	 */
	public static final String TABLE_NAME = "News_Author";
	...
	public static final String ORDER_BY_JPQL =
		" ORDER BY author.authorName ASC";

	public static final String ORDER_BY_SQL =
		" ORDER BY News_Author.authorName ASC";
	 ...
	 */
	@Deprecated
	public static final long AUTHORNAME_COLUMN_BITMASK = 8L;
	...
	static {
		...
		attributeGetterFunctions.put("authorCode", Author::getAuthorCode);
		attributeSetterBiConsumers.put(
			"authorCode", (BiConsumer<Author, String>)Author::setAuthorCode);
	...
	public int compareTo(Author author) {
		...
		value = getAuthorName().compareTo(author.getAuthorName());
	...
	public CacheModel<Author> toCacheModel() {
		...
		authorCacheModel.authorCode = getAuthorCode();

		String authorCode = authorCacheModel.authorCode;

		if ((authorCode != null) && (authorCode.length() == 0)) {
			authorCacheModel.authorCode = null;
		}
	...
	static {
		...
		columnBitmasks.put("authorCode", 256L);
