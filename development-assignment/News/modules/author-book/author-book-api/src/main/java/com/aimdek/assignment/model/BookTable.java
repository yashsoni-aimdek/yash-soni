...
/**
 * The table class for the &quot;News_Book&quot; database table.
 *
...
public class BookTable extends BaseTable<BookTable> {
	...
	public final Column<BookTable, String> bookCode = createColumn(
		"bookCode", String.class, Types.VARCHAR, Column.FLAG_DEFAULT);
