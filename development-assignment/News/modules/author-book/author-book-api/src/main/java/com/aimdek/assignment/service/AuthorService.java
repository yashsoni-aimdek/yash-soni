...
public interface AuthorService extends BaseService {
	 ...
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify this interface directly. Add custom service methods to <code>com.aimdek.assignment.service.impl.AuthorServiceImpl</code> and rerun ServiceBuilder to automatically copy the method declarations to this interface. Consume the author remote service via injection or a <code>org.osgi.util.tracker.ServiceTracker</code>. Use {@link AuthorServiceUtil} if injection and service tracking are not available.
	 */
