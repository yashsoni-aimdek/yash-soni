 ...
 * <code>com.aimdek.assignment.service.impl.AuthorLocalServiceImpl</code> and
...
public class AuthorLocalServiceUtil {
	 ...
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify this class directly. Add custom service methods to <code>com.aimdek.assignment.service.impl.AuthorLocalServiceImpl</code> and rerun ServiceBuilder to regenerate this class.
	 */
	...
	public static Author addAuthor(
		...
		return getService().addAuthor(author, serviceContext);
	}
	...
	public static Author updateAuthor(
		...
		return getService().updateAuthor(author, serviceContext);
	}
