...
/**
 * The table class for the &quot;News_Author&quot; database table.
 *
...
public class AuthorTable extends BaseTable<AuthorTable> {
	...
	public final Column<AuthorTable, String> authorCode = createColumn(
	...
	public final Column<AuthorTable, String> bookId = createColumn(
		"bookId", String.class, Types.VARCHAR, Column.FLAG_DEFAULT);

	private AuthorTable() {
		super("News_Author", AuthorTable::new);
	}
